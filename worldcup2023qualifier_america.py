...
The base url is 'https://www.fiba.basketball/basketballworldcup/2023/americas-qualifiers/'.
...
output_folder = './data/worldcup2023_qualifier/america'
...
CTY_TO_IOC = {'Argentina': 'ARG', 'Bahamas': 'BAH', 'Brazil': 'BRA', 'Canada': 'CAN',
              'Chile': 'CHI', 'Colombia': 'COL', 'Cuba': 'CUB', 'Dominican-Republic': 'DOM',
              'Mexico': 'MEX', 'Panama': 'PAN', 'Paraguay': 'PAR', 'Puerto-Rico': 'PUR',
              'Uruguay': 'URU', 'USA': 'USA', 'Venezuela': 'VEN', 'Virgin-Islands': 'ISV'}


def build_url(country):
    """Creates a url from the given country."""
    return f'https://www.fiba.basketball/basketballworldcup/2023/americas-qualifiers/team/{country}#|tab=games_and_results'
