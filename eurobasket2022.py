"""Crawl match results in the FIBA eurobasket 2022 games.

The base url is 'https://www.fiba.basketball/eurobasket/2022'.
...
output_folder = './data/eurobasket/2022'
...
CTY_TO_IOC = {'Belgium': 'BLG', 'Bosnia-and-Herzegovina': 'BIH', 'Bulgaria': 'BUL', 'Croatia': 'CRO',
              ...
              'Hungary': 'HUN', 'Israel': 'ISR', 'Italy': 'ITA', 'Lithuania': 'LTU',
              'Montenegro': 'MNE', 'Netherlands': 'NED', 'Poland': 'POL', 'Serbia': 'SRB',
              'Slovenia': 'SLO', 'Spain': 'ESP', 'Turkey': 'TUR', 'Ukraine': 'UKR'}


def build_url(country):
    """Creates a url from the given country."""
    return f'https://www.fiba.basketball/eurobasket/2022/team/{country}#|tab=games_and_results'
