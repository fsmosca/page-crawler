...
The base url is 'https://www.fiba.basketball/olympics/2016'.
...
output_folder = './data/olympics/2016'
...
CTY_TO_IOC = {'Argentina': 'ARG', 'Australia': 'AUS', 'Brazil': 'BRA', 'China': 'CHN',
              'Croatia': 'CRO', 'France': 'FRA', 'Lithuania': 'LTU', 'Nigeria': 'NGR',
              'Serbia': 'SRB', 'Spain': 'ESP', 'USA': 'USA', 'Venezuela': 'VEN'}


def build_url(country):
    """Creates a url from the given country."""
    return f'https://www.fiba.basketball/olympics/2016/{country}#|tab=games_and_results'
