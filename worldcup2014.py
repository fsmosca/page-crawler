"""Crawl match results in the FIBA World Cup 2014 games.

The base url is 'https://www.fiba.basketball/basketballworldcup/2014/'.
...
output_folder = './data/worldcup/2014'
...
CTY_TO_IOC = {'Angola': 'ANG', 'Argentina': 'ARG', 'Australia': 'AUS', 'Brazil': 'BRA',
              'Croatia': 'CRO', 'Dominican-Republic': 'DOM', 'Egypt': 'EGY', 'Finland': 'FIN', 
              'France': 'FRA', 'Greece': 'GRE', 'Iran': 'IRI', 'Korea': 'KOR',
              'Lithuania': 'LTU', 'Mexico': 'MEX', 'New-Zealand': 'NZL', 'Philippines': 'PHI',
              'Puerto-Rico': 'PUR', 'Senegal': 'SEN', 'Serbia': 'SRB', 'Slovenia': 'SLO',
              'Spain': 'ESP', 'Turkey': 'TUR', 'Ukraine': 'UKR', 'USA': 'USA'}


def build_url(country):
    """Creates a url from the given country."""
    return f'https://www.fiba.basketball/basketballworldcup/2014/{country}#|tab=games_and_results'
