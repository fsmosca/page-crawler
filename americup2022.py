"""Crawl match results in the FIBA americup 2020.

The base url is 'https://www.fiba.basketball/americup/2022/'.
...
output_folder = './data/americup/2022'
...
CTY_TO_IOC = {'Argentina': 'ARG', 'Brazil': 'BRA', 'Canada': 'CAN', 'Colombia': 'COL',
              'Dominican-Republic': 'DOM', 'Mexico': 'MEX', 'Panama': 'PAN', 'Puerto-Rico': 'PUR',
              'Uruguay': 'URU', 'USA': 'USA', 'Venezuela': 'VEN', 'Virgin-Islands': 'ISV'}


def build_url(country):
    """Creates a url from the given country."""
    return f'https://www.fiba.basketball/americup/2022/team/{country}#|tab=games_and_results'
