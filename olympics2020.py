...
The base url is 'https://www.fiba.basketball/olympics/men/2020/'.
...
output_folder = './data/olympics/2020'
...
CTY_TO_IOC = {'Argentina': 'ARG', 'Australia': 'AUS', 'Czech-Republic': 'CZE', 'France': 'FRA',
              'Germany': 'GER', 'Iran': 'IRI', 'Italy': 'ITA', 'Japan': 'JPN',
              'Nigeria': 'NGR', 'Spain': 'ESP', 'Slovenia': 'SLO', 'USA': 'USA'}


def build_url(country):
    """Creates a url from the given country."""
    return f'https://www.fiba.basketball/olympics/men/2020/team/{country}#|tab=games_and_results'
