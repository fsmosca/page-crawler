...
The base url is 'https://www.fiba.basketball/basketballworldcup/2023/asian-qualifiers/'.
...
output_folder = './data/worldcup_qualifier/2023/asia'
...
CTY_TO_IOC = {'Australia': 'AUS', 'Bahrain': 'BRN', 'China': 'CHN', 'Chinese-Taipei': 'TPE',
              'India': 'IND', 'Indonesia': 'INA' , 'Iran': 'IRI', 'Japan': 'JPN',
              'Jordan': 'JOR', 'Kazakhstan': 'KAZ', 'Lebanon': 'LBN', 'New-Zealand': 'NZL',
              'Philippines': 'PHI', 'Saudi-Arabia': 'KSA', 'Syria': 'SYR'}


def build_url(country):
    """Creates a url from the given country."""
    return f'https://www.fiba.basketball/basketballworldcup/2023/asian-qualifiers/team/{country}#|tab=games_and_results'
