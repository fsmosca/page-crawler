...
The base url is 'https://www.fiba.basketball/basketballworldcup/2023/african-qualifiers/'.
...
output_folder = './data/worldcup2023_qualifier/africa'
...
CTY_TO_IOC = {'Angola': 'ANG', 'Cameroon': 'CMR', 'Cape-Verde': 'CPV', 'Central-African-Rep-': 'CAF',
              'Congo-DR': 'COD', 'Cote-d-Ivoire': 'CIV', 'Egypt': 'EGY', 'Guinea': 'GUI' ,
              'Kenya': 'KEN', 'Nigeria': 'NGR', 'Rwanda': 'RWA', 'Senegal': 'SEN',
              'South-Sudan': 'SSD', 'Tunisia': 'TUN', 'Uganda': 'UGA'}


def build_url(country):
    """Creates a url from the given country."""
    return f'https://www.fiba.basketball/basketballworldcup/2023/african-qualifiers/team/{country}#|tab=games_and_results'
