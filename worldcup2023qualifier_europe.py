"""Crawl match results in the FIBA World Cup 2023 asia qualifier games.

The base url is 'https://www.fiba.basketball/basketballworldcup/2023/european-qualifiers/'.
...
output_folder = './data/worldcup2023_qualifier/europe'
...
CTY_TO_IOC = {'Belgium': 'BLG', 'Bosnia-and-Herzegovina': 'BIH', 'Bulgaria': 'BUL', 'Croatia': 'CRO',
              'Czech-Republic': 'CZE', 'Estonia': 'EST', 'Finland': 'FIN', 'France': 'FRA' ,
              'Georgia': 'GEO', 'Germany': 'GER', 'Great-Britain': 'GBR', 'Greece': 'GRE',
              'Hungary': 'HUN', 'Iceland': 'ISL', 'Israel': 'ISR', 'Italy': 'ITA',
              'Latvia': 'LAT', 'Lithuania': 'LTU', 'Montenegro': 'MNE', 'Netherlands': 'NED',
              'North-Macedonia': 'MKD', 'Poland': 'POL', 'Portugal': 'POR', 'Serbia': 'SRB',   
              'Slovakia': 'SVK', 'Slovenia': 'SLO', 'Spain': 'ESP', 'Sweden': 'SWE', 
              'Turkey': 'TUR', 'Ukraine': 'UKR'}


def build_url(country):
    """Creates a url from the given country."""
    return f'https://www.fiba.basketball/basketballworldcup/2023/european-qualifiers/team/{country}#|tab=games_and_results'
