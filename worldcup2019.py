"""Crawl match results in the FIBA World Cup 2019 games.

The base url is 'https://www.fiba.basketball/basketballworldcup/2019/'.
...
output_folder = './data/worldcup/2019'
...
CTY_TO_IOC = {'Angola': 'ANG', 'Argentina': 'ARG', 'Australia': 'AUS', 'Brazil': 'BRA',
              'Canada': 'CAN', 'China': 'CHN', 'Cote-d-Ivoire': 'CIV', 'Czech-Republic': 'CZE',
              'Dominican-Republic': 'DOM', 'France': 'FRA', 'Germany': 'GER', 'Greece': 'GRE',
              'Iran': 'IRI', 'Italy': 'ITA', 'Japan': 'JPN', 'Jordan': 'JOR',
              'Korea': 'KOR', 'Lithuania': 'LTU', 'Montenegro': 'MNE', 'New-Zealand': 'NZL',
              'Nigeria': 'NGR', 'Philippines': 'PHI', 'Poland': 'POL', 'Puerto-Rico': 'PUR',
              'Russia': 'RUS', 'Senegal': 'SEN', 'Serbia': 'SRB', 'Spain': 'ESP',
              'Tunisia': 'TUN', 'Turkey': 'TUR', 'USA': 'USA', 'Venezuela': 'VEN'}


def build_url(country):
    """Creates a url from the given country."""
    return f'https://www.fiba.basketball/basketballworldcup/2019/team/{country}#|tab=games_and_results'
    ...
    with sync_playwright() as p:
        ...
        while True:
            try:
                ...
                a = page.query_selector('div.schedule_list.local')
